...
{% elseif STEP == 2 %}
            <div class="reg-step reg-step2" style="opacity:0;">
                ...
                <div class="form-line"><label class="reg-label-t">Nickname:</label><input type="text" class="textbox role-reg-nickname" autocomplete="off"></div>
                <div class="form-line"><label class="reg-label-t">Username:</label><input type="text" class="textbox role-reg-username" autocomplete="off"></div>
                <div class="form-line"><label class="reg-label-t">Password:</label><input type="password" class="textbox role-reg-password" autocomplete="off" style="ime-mode:disabled;"></div>
                <div class="form-line">
                <input type="radio" name="reg-gender" id="reg-gender-male" checked><label for="reg-gender-male" class="reg-label-input reg-label-margin">Male</label>
                <input type="radio" name="reg-gender" id="reg-gender-female"><label for="reg-gender-female" class="reg-label-input reg-label-margin">Female</label>
                <input type="radio" name="reg-gender" id="reg-gender-other"><label for="reg-gender-other" class="reg-label-input">Other</label> 
                </div>
                <div class="form-line">
                <input type="checkbox" name="reg-agree" id="reg-agree"><label for="reg-agree" class="reg-label-input">I agree to the </label><a href="{{ BASE_PREFIX }}/help" target="_blank" class="dark reg-label-input">Vijos Terms</a>
                </div>
